...
>
  ...
  >
  Vi unngår inntil videre å bruke `aria-errormessage` fordi hjelpemidler ikke støtter den fullt enda. Vi oppdaterer   retningslinjene på dette hvis støtten blir bedre i fremtiden. [Se diskusjon på github](https://github.com/digdir/designsystemet/discussions/1684)
